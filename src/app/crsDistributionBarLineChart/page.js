  ...
  useEffect(() => {
    ...
    const processChartData = (data) => {
      ...
      const id0 = filteredRounds
        .map((round) => ({
          x: round.drawDate,
          type: round.drawName.replace(/\s*\(Version (1|2)\)/g, ""), // 移除 "Version 1 & 2",
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div style={{ textAlign: "center", marginBottom: "10px" }}>
          ...
          <select
            ...
            className="border rounded-md px-2 py-1 text-black w-32"
          >
        ...
        >
          <div>
            <label htmlFor="startDate" style={{ color: "black" }}>
              {t.startDate}：
            </label>
            <input
              type="date"
